...
var tableRow = exports.tableRow = (0, _nodeTypes.tableRow)({
  parseDOM: [{
    tag: 'tr'
  }],
...
var tableCell = exports.tableCell = (0, _nodeTypes.tableCell)({
  parseDOM: [
...
var tableHeader = exports.tableHeader = (0, _nodeTypes.tableHeader)({
  parseDOM: [{
    tag: 'th',
    getAttrs: function getAttrs(dom) {
      return getCellAttrs(dom, {
