  ...
  return (_parentTableNode$cont = parentTableNode.content) === null || _parentTableNode$cont === void 0 ? void 0 : _parentTableNode$cont.map(function (childNode) {
    if (childNode) {
      switch (childNode.type) {
        case 'text':
          {
            return tableRow([tableCell({})(paragraph(childNode))].concat(_toConsumableArray(new Array(maxColsCount - 1).fill(tableCell({})(paragraph())))));
          }
        case 'tableCell':
          {
        ...
        case 'tableRow':
          {
            if (isEmpty(childNode)) {
              return tableRow(_toConsumableArray(new Array(maxColsCount).fill(tableCell({})(paragraph()))));
            }
            return childNode;
          }
        default:
