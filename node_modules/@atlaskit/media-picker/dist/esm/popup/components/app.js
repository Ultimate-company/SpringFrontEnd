...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.renderClipboard = function () {
            var _a = _this.props, onUploadPreviewUpdate = _a.onUploadPreviewUpdate, onUploadEnd = _a.onUploadEnd, onUploadError = _a.onUploadError, tenantUploadParams = _a.tenantUploadParams;
            var config = {
                uploadParams: tenantUploadParams,
                shouldCopyFileToRecents: false,
            };
            return (React.createElement(Clipboard, { mediaClient: _this.componentMediaClient, config: config, onUploadsStart: _this.onDrop, onPreviewUpdate: onUploadPreviewUpdate, onEnd: onUploadEnd, onError: onUploadError }));
        };
        _this.renderBrowser = function () {
            var _a = _this.props, tenantUploadParams = _a.tenantUploadParams, onUploadsStart = _a.onUploadsStart, onUploadPreviewUpdate = _a.onUploadPreviewUpdate, onUploadEnd = _a.onUploadEnd, onUploadError = _a.onUploadError;
            var config = {
                uploadParams: tenantUploadParams,
                shouldCopyFileToRecents: false,
                multiple: true,
            };
            return (React.createElement(BrowserComponent, { ref: _this.browserRef, mediaClient: _this.componentMediaClient, config: config, onUploadsStart: onUploadsStart, onPreviewUpdate: onUploadPreviewUpdate, onEnd: onUploadEnd, onError: onUploadError }));
        };
        _this.renderDropzone = function () {
            ...
            return (React.createElement(Dropzone, { ref: _this.dropzoneRef, mediaClient: _this.componentMediaClient, config: config, onUploadsStart: _this.onDrop, onPreviewUpdate: onUploadPreviewUpdate, onEnd: onUploadEnd, onError: onUploadError, onDragEnter: _this.onDragEnter, onDragLeave: _this.onDragLeave }));
        };
