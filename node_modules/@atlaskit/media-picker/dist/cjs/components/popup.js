...
var PopupImpl = /** @class */ (function (_super) {
    ...
    PopupImpl.prototype.renderPopup = function () {
        ...
        react_dom_1.render(react_1.default.createElement(app_1.default, { store: this.store, proxyReactContext: this.proxyReactContext, tenantUploadParams: this.tenantUploadParams }), container);
        return container;
    };
    return PopupImpl;
