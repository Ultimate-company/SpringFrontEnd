...
var GiphyView = /** @class */ (function (_super) {
    ...
    function GiphyView(props) {
        ...
        _this.renderError = function () {
            return (react_1.default.createElement(styles_1.WarningContainer, null,
                ...
                react_1.default.createElement(styles_1.WarningHeading, null,
                    react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.cant_retrieve_gifs))),
                react_1.default.createElement(styles_1.WarningSuggestion, null,
                    react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.check_your_network))),
                react_1.default.createElement(button_1.default, { onClick: _this.handleRetryButtonClick },
                    react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.try_again)))));
        };
        ...
        _this.renderMasonaryLayout = function (cardModels) {
            ...
            return (react_1.default.createElement(bricksGrid_1.BricksLayout, { id: "mediapicker-gif-layout", sizes: [{ columns: NUMBER_OF_COLUMNS, gutter: GAP_SIZE }] }, cards));
        };
    ...
    GiphyView.prototype.render = function () {
        ...
        return (react_1.default.createElement(styles_1.Container, { id: "mediapicker-giphy-container" },
