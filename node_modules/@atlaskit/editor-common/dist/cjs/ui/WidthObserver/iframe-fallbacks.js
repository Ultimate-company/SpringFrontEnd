...
function Iframe(props) {
    if (utils_1.browser.ie_version === 11) {
...
exports.IframeWidthObserverFallbackWrapper = react_1.default.memo(function (props) {
    var supportsResizeObserver = utils_2.browser.supportsResizeObserver, supportsIntersectionObserver = utils_2.browser.supportsIntersectionObserver;
