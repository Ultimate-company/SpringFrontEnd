...
export declare const akEditorSelectedBorder = "#0065FF";
...
export declare const akMediaSingleResizeZIndex: number;
...
export declare const blockNodesVerticalMargin = "1.143rem";
