...
var DialogContentText = React5.forwardRef(function DialogContentText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(DialogContentTextRoot, _extends({
    component: "p",
    variant: "body1",
...
var DialogTitle = React6.forwardRef(function DialogTitle2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogTitle"
  });
  ...
  const {
    titleId = idProp
  } = React6.useContext(DialogContext_default);
  return (0, import_jsx_runtime5.jsx)(DialogTitleRoot, _extends({
    component: "h2",
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
...
//# sourceMappingURL=chunk-QLFIF7TM.js.map
