import {
  ...
  useEditor
} from "./chunk-WFVASGJM.js";
import "./chunk-ZNUSNXF5.js";
import {
  Decoration,
  DecorationSet,
  Extension,
...
} from "./chunk-XYOMATUA.js";
import {
  Collapse_default,
  Link_default,
  ToggleButton_default,
  toggleButtonClasses_default
} from "./chunk-E6ZRMFSF.js";
import "./chunk-WV7SD2O4.js";
import {
  DialogActions_default
} from "./chunk-CUVGV7CK.js";
import "./chunk-E47OWEGC.js";
import "./chunk-GCYLMA6J.js";
import {
  MenuItem_default
} from "./chunk-56IWMQ4G.js";
import "./chunk-CCSMOSU7.js";
import {
  Stack_default
} from "./chunk-PUQGQKI4.js";
import {
  Button_default,
  ClickAwayListener,
  Select_default,
...
} from "./chunk-CVJVY6UO.js";
import "./chunk-E7N7UIFD.js";
import "./chunk-XUKUIGBQ.js";
import {
  Popper_default,
  Tooltip_default
} from "./chunk-LJCXNWRA.js";
import "./chunk-EA2NDS4C.js";
import "./chunk-GSOLIU3N.js";
import "./chunk-CZZZYPQ6.js";
import "./chunk-7FMUZLSF.js";
import "./chunk-5POWXTFR.js";
import "./chunk-WRNNPOWJ.js";
import {
  Fade_default
} from "./chunk-PZP5ZKDZ.js";
import "./chunk-QGQJ5NHE.js";
import "./chunk-4BTCZRUJ.js";
import {
  Divider_default
} from "./chunk-3S3YYEES.js";
import "./chunk-NB5T5EG4.js";
import "./chunk-UWZ7ZPN3.js";
import "./chunk-HMXMV5VH.js";
import {
  Paper_default
} from "./chunk-4E7S4DJV.js";
import "./chunk-QRURAGMS.js";
import "./chunk-77LAQLGR.js";
import "./chunk-V7HQH7OR.js";
import "./chunk-FE5PZXAS.js";
...
} from "./chunk-ZGNOMVXG.js";
import "./chunk-CZOQDWJK.js";
import "./chunk-CLDW6MN7.js";
import "./chunk-DYOKMEWT.js";
import "./chunk-ZW2UKZGO.js";
import "./chunk-DOCILJRY.js";
import {
  createSvgIcon,
  svgIconClasses_default
} from "./chunk-DMGSXTL5.js";
import "./chunk-2QNTXJ5T.js";
import "./chunk-QZNRN7C4.js";
import {
  Box_default
} from "./chunk-XTJQB55M.js";
import "./chunk-XR5E43YU.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-RZDU3TRZ.js";
import {
  alpha,
  darken,
  lighten,
  rgbToHex
} from "./chunk-FWIWMUYP.js";
import "./chunk-LHMD4SLY.js";
import "./chunk-LETF4BER.js";
import {
  require_interopRequireDefault
} from "./chunk-RZIUJFPU.js";
import {
...
function createWithStyles(params) {
  ...
  function withStyles2(Component2, cssObjectByRuleNameOrGetCssObjectByRuleName, params2) {
    ...
    const Out = (0, import_react6.forwardRef)(function(props, ref) {
      ...
      return import_react6.default.createElement(Component_, Object.assign({ ref, className: getHasNonRootClasses(classes) ? className : rootClassName }, typeof Component2 === "string" ? {} : { classes }, rest));
    });
    if (name !== void 0) {
...
function ControlledBubbleMenu({ editor, open, className, classes: overrideClasses = {}, children, anchorEl, container, disablePortal, placement = "top", fallbackPlacements = [
  ...
  const theme = useTheme();
  const defaultAnchorEl = (0, import_react10.useCallback)(() => {
  ...
  ], anchorEl: anchorEl !== null && anchorEl !== void 0 ? anchorEl : defaultAnchorEl, className: cx(controlledBubbleMenuClasses.root, classes.root, className), container, disablePortal, transition: true, children: ({ TransitionProps }) => (0, import_jsx_runtime.jsx)(Fade_default, { ...TransitionProps, timeout: {
...
var RichTextEditorContext = (0, import_react11.createContext)(void 0);
function useRichTextEditorContext() {
  const editor = (0, import_react11.useContext)(RichTextEditorContext);
  if (editor === void 0) {
...
function EditLinkMenuContent({ editor, onCancel, onSave, labels }) {
  ...
  const [textValue, setTextValue] = (0, import_react13.useState)(initialText);
  const [hrefValue, setHrefValue] = (0, import_react13.useState)(existingHref);
  const textRef = (0, import_react13.useRef)(null);
  const hrefRef = (0, import_react13.useRef)(null);
  ...
  const formatHref = (0, import_react13.useCallback)(() => {
    if (!hrefRef.current) {
      return;
    }
    let currentHrefValue = hrefRef.current.value.trim();
    if (currentHrefValue && !currentHrefValue.startsWith("http://") && !currentHrefValue.startsWith("https://") && !currentHrefValue.startsWith("mailto:") && !currentHrefValue.startsWith("tel:")) {
      currentHrefValue = `http://${currentHrefValue}`;
    }
    setHrefValue((0, import_encodeurl.default)(currentHrefValue));
  }, []);
...
function LinkBubbleMenu({ labels, ...controlledBubbleMenuProps }) {
...
function RichTextContent({ className, classes: overrideClasses = {} }) {
  ...
  const editor = useRichTextEditorContext();
  const editorClasses = (0, import_react15.useMemo)(() => cx(richTextContentClasses.root, className, classes.root, (editor === null || editor === void 0 ? void 0 : editor.isEditable) ? [richTextContentClasses.editable, classes.editable] : [richTextContentClasses.readonly, classes.readonly]), [className, classes, cx, editor === null || editor === void 0 ? void 0 : editor.isEditable]);
...
function useDebouncedFocus({ editor, wait = 250 }) {
  const [isFocusedDebounced, setIsFocusedDebounced] = (0, import_react16.useState)(!!(editor === null || editor === void 0 ? void 0 : editor.isFocused));
  const updateIsFocusedDebounced = (0, import_react16.useMemo)(() => (0, import_debounce.default)((focused) => setIsFocusedDebounced(focused), wait), [wait]);
...
var DebounceRender = class extends import_react17.Component {
  constructor(props) {
    var _a, _b;
    super(props);
...
// node_modules/mui-tiptap/dist/esm/RichTextEditor.js
var RichTextEditor = (0, import_react19.forwardRef)(function RichTextEditor2({
  className,
  renderControls,
  RichTextFieldProps = {},
  children,
...
function RichTextReadOnlyInternal(props) {
  ...
  const previousContent = (0, import_react21.useRef)(props.content);
...
function useEditorOnEditableUpdate({ editor, callback }) {
  ...
  const isEditableRef = (0, import_react22.useRef)(editor === null || editor === void 0 ? void 0 : editor.isEditable);
...
function TableBubbleMenu({ disableDebounce = false, DebounceProps, labels, ...controlledBubbleMenuProps }) {
  ...
  const bubbleMenuAnchorEl = (0, import_react23.useMemo)(() => editor ? {
    getBoundingClientRect: () => {
...
function i(e2) {
  var t2 = (0, import_react24.useRef)(e2), n2 = (0, import_react24.useRef)(function(e3) {
...
var m = import_react24.default.memo(function(o2) {
  var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0, import_react24.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0, import_react24.useRef)(null), _2 = (0, import_react24.useRef)(false), x2 = (0, import_react24.useMemo)(function() {
    var e2 = function(e3) {
  ...
  return (0, import_react24.useEffect)(function() {
    return H;
  }, [H]), import_react24.default.createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E, tabIndex: 0, role: "slider" }));
});
var g = function(e2) {
...
var p = function(r2) {
  ...
  return import_react24.default.createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, import_react24.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t2 } }));
};
...
var S = import_react24.default.memo(function(r2) {
  var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
  return import_react24.default.createElement("div", { className: o2 }, import_react24.default.createElement(m, { onMove: function(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react24.default.createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q({ h: t2, s: 100, v: 100, a: 1 }) })));
});
var T = import_react24.default.memo(function(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return import_react24.default.createElement("div", { className: "react-colorful__saturation", style: o2 }, import_react24.default.createElement(m, { onMove: function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, onKey: function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, import_react24.default.createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q(t2) })));
});
...
function Y(e2, t2, l2) {
  var u2 = i(l2), c2 = (0, import_react24.useState)(function() {
    return e2.toHsva(t2);
  }), s2 = c2[0], f2 = c2[1], v2 = (0, import_react24.useRef)({ color: t2, hsva: s2 });
  (0, import_react24.useEffect)(function() {
    if (!e2.equal(t2, v2.current.color)) {
      var r2 = e2.toHsva(t2);
      v2.current = { hsva: r2, color: t2 }, f2(r2);
    }
  }, [t2, e2]), (0, import_react24.useEffect)(function() {
    var r2;
    F(s2, v2.current.hsva) || e2.equal(r2 = e2.fromHsva(s2), v2.current.color) || (v2.current = { hsva: s2, color: r2 }, u2(r2));
  }, [s2, e2, u2]);
  var d2 = (0, import_react24.useCallback)(function(e3) {
    f2(function(r2) {
...
var R;
var V = "undefined" != typeof window ? import_react24.useLayoutEffect : import_react24.useEffect;
var $ = function() {
...
var U = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = void 0 === a2 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react24.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return import_react24.default.createElement("div", u({}, s2, { ref: f2, className: m2 }), import_react24.default.createElement(T, { hsva: d2, onChange: h2 }), import_react24.default.createElement(S, { hue: d2.h, onChange: h2, className: "react-colorful__last-control" }));
};
var W = { defaultColor: "000", toHsva: x, fromHsva: function(e2) {
  return w({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
}, equal: X };
var Z = function(r2) {
  return import_react24.default.createElement(U, u({}, r2, { colorModel: W }));
};
var ee = function(r2) {
  ...
  return import_react24.default.createElement("div", { className: l2 }, import_react24.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), import_react24.default.createElement(m, { onMove: function(e2) {
    o2({ a: e2.left });
  }, onKey: function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react24.default.createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
};
var re = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = void 0 === a2 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react24.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return import_react24.default.createElement("div", u({}, s2, { ref: f2, className: m2 }), import_react24.default.createElement(T, { hsva: d2, onChange: h2 }), import_react24.default.createElement(S, { hue: d2.h, onChange: h2 }), import_react24.default.createElement(ee, { hsva: d2, onChange: h2, className: "react-colorful__last-control" }));
};
var te = { defaultColor: "0001", toHsva: x, fromHsva: w, equal: X };
var ne = function(r2) {
  return import_react24.default.createElement(re, u({}, r2, { colorModel: te }));
};
...
var ColorSwatchButton = (0, import_react25.forwardRef)(({ value: colorValue, label, padding, active, ...buttonProps }, ref) => {
...
function ColorPicker({ value, onChange, swatchColors, colorToHex: colorToHex2 = colorToHex, disableAlpha = false, labels = {} }) {
  ...
  return (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [disableAlpha ? (0, import_jsx_runtime37.jsx)(Z, { color: colorValueAsHex !== null && colorValueAsHex !== void 0 ? colorValueAsHex : "#000000", onChange: (color) => onChange(color, "gradient"), className: classes.gradientPicker }) : (0, import_jsx_runtime37.jsx)(ne, { color: colorValueAsHex !== null && colorValueAsHex !== void 0 ? colorValueAsHex : "#000000", onChange: (color) => onChange(color, "gradient"), className: classes.gradientPicker }), (0, import_jsx_runtime37.jsx)(TextField_default, { placeholder: textFieldPlaceholder, variant: "outlined", size: "small", defaultValue: value || "", inputRef, spellCheck: false, className: classes.colorTextInput, onChange: (event) => {
    ...
    onClick: () => {
      var _a;
      return onChange((_a = swatchColor.value) !== null && _a !== void 0 ? _a : "", "swatch");
    },
...
function ColorPickerPopperBody({ value, onCancel, onSave, swatchColors, labels = {}, ColorPickerProps }) {
  ...
  const [localColor, setLocalColor] = (0, import_react27.useState)(value);
...
var useStyles17 = makeStyles({ name: { ColorPickerPopper } })({
  root: {
    zIndex: Z_INDEXES.BUBBLE_MENU,
...
function MenuButtonImageUpload({ onUploadFiles, inputProps, insertImages: insertImages2 = insertImages, ...props }) {
  const editor = useRichTextEditorContext();
  const fileInput = (0, import_react30.useRef)(null);
...
function MenuSelect({ tooltipTitle, ...selectProps }) {
  ...
  const [tooltipOpen, setTooltipOpen] = (0, import_react31.useState)(false);
...
function MenuSelectFontSize({ options = DEFAULT_FONT_SIZE_SELECT_OPTIONS, sizeOptions, hideUnsetOption = false, unsetOptionLabel = "Default", unsetOptionContent, emptyLabel, emptyValue, ...menuSelectProps }) {
  var _a;
...
function MenuSelectHeading({ labels, ...menuSelectProps }) {
  var _a, _b, _c, _d, _e, _f, _g, _h;
  const { classes, cx } = useStyles22();
  const editor = useRichTextEditorContext();
  const handleHeadingType = (0, import_react32.useCallback)((event) => {
    const value = event.target.value;
  ...
  if (editor === null || editor === void 0 ? void 0 : editor.isActive("paragraph")) {
    ...
    const level = numCurrentNodeLevels === 1 ? currentNodeLevels[0] : void 0;
  ...
  const enabledHeadingLevels = (0, import_react32.useMemo)(() => {
    var _a2;
  ...
  return (
    ...
    (0, import_jsx_runtime72.jsxs)(MenuSelect, { onChange: handleHeadingType, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || !isCurrentlyParagraphOrHeading && !canSetParagraph && !canSetHeading, displayEmpty: true, renderValue: (selected) => {
      ...
      ...menuSelectProps.inputProps,
      className: cx(classes.selectInput, (_a = menuSelectProps.inputProps) === null || _a === void 0 ? void 0 : _a.className)
    }, children: [(0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Paragraph, disabled: !isCurrentlyParagraphOrHeading && !canSetParagraph, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "0"], placement: "right", contentWrapperClassName: classes.menuOption, children: (_b = labels === null || labels === void 0 ? void 0 : labels.paragraph) !== null && _b !== void 0 ? _b : HEADING_OPTION_VALUES.Paragraph }) }), enabledHeadingLevels.has(1) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading1, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "1"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption1), children: (_c = labels === null || labels === void 0 ? void 0 : labels.heading1) !== null && _c !== void 0 ? _c : HEADING_OPTION_VALUES.Heading1 }) }), enabledHeadingLevels.has(2) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading2, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "2"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption2), children: (_d = labels === null || labels === void 0 ? void 0 : labels.heading2) !== null && _d !== void 0 ? _d : HEADING_OPTION_VALUES.Heading2 }) }), enabledHeadingLevels.has(3) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading3, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "3"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption3), children: (_e = labels === null || labels === void 0 ? void 0 : labels.heading3) !== null && _e !== void 0 ? _e : HEADING_OPTION_VALUES.Heading3 }) }), enabledHeadingLevels.has(4) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading4, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "4"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption4), children: (_f = labels === null || labels === void 0 ? void 0 : labels.heading4) !== null && _f !== void 0 ? _f : HEADING_OPTION_VALUES.Heading4 }) }), enabledHeadingLevels.has(5) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading5, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "5"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption5), children: (_g = labels === null || labels === void 0 ? void 0 : labels.heading5) !== null && _g !== void 0 ? _g : HEADING_OPTION_VALUES.Heading5 }) }), enabledHeadingLevels.has(6) && (0, import_jsx_runtime72.jsx)(MenuItem_default, { value: HEADING_OPTION_VALUES.Heading6, disabled: !canSetHeading, children: (0, import_jsx_runtime72.jsx)(MenuButtonTooltip, { label: "", shortcutKeys: ["mod", "alt", "6"], placement: "right", contentWrapperClassName: cx(classes.menuOption, classes.headingOption, classes.headingOption6), children: (_h = labels === null || labels === void 0 ? void 0 : labels.heading6) !== null && _h !== void 0 ? _h : HEADING_OPTION_VALUES.Heading6 }) })] })
  );
}
...
function MenuSelectTextAlign({ options = DEFAULT_ALIGNMENT_OPTIONS, emptyLabel = "", alignmentOptions, ...menuSelectProps }) {
  var _a, _b, _c;
  ...
  const handleAlignmentSelect = (0, import_react33.useCallback)((event) => {
    const alignment = event.target.value;
    editor === null || editor === void 0 ? void 0 : editor.chain().setTextAlign(alignment).focus().run();
  }, [editor]);
  const textAlignExtensionOptions = (0, import_react33.useMemo)(() => {
  ...
  const enabledAlignments = (0, import_react33.useMemo)(() => {
...
function HeadingWithAnchorComponent({ editor, node, extension }) {
  ...
  const textSerializers = (0, import_react35.useMemo)(() => getTextSerializersFromSchema(editor.schema), [editor.schema]);
...
function ResizableImageResizer({ onResize, className }) {
  ...
  const [mouseDown, setMouseDown] = (0, import_react37.useState)(false);
  ...
  const handleMouseDown3 = (0, import_react37.useCallback)((_event) => {
    setMouseDown(true);
  }, []);
  return (
...
function ResizableImageComponent({ node, selected, updateAttributes }) {
  ...
  const { attrs } = node;
  const imageRef = (0, import_react39.useRef)(null);
  const handleResize = (0, import_react39.useMemo)(() => (
  ...
  return (0, import_jsx_runtime76.jsx)(NodeViewWrapper, { style: {
    // Handle @tiptap/extension-text-align. Ideally we'd be able to inherit
    // this style from TextAlign's GlobalAttributes directly, but those are
    // only applied via `renderHTML` and not the `NodeView` renderer
    // (https://github.com/ueberdosis/tiptap/blob/6c34dec33ac39c9f037a0a72e4525f3fc6d422bf/packages/extension-text-align/src/text-align.ts#L43-L49),
  ...
  }), selected && (0, import_jsx_runtime76.jsx)(ResizableImageResizer, { onResize: handleResize, className: classes.resizer })] }) });
}
